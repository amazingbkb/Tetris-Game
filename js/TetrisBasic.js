...
// Starting X position for Tetromino
let startX = 4; 

// Starting Y position for Tetromino
let startY = 0;
...
function SetupCanvas(){
    ...
    ctx.fillText("Space : Rotate Right", 310, 463);
...
function HandleKeyPress(key){
    ...
    // keycode (DOWN)
        ...
        MoveTetrominoDown();
        //  keycode (SPACE) calls for rotation of Tetromino
